...
M.on_attach = function(client, bufnr)
	...
	-- mapkey("<leader>gfd", "Lspsaga finder", "n", opts) -- go to definition
	...
	-- mapkey("<leader>iD", "Lspsaga show_line_diagnostics", "n", opts) -- show  diagnostics for line
	-- mapkey("<leader>id", "Lspsaga show_cursor_diagnostics", "n", opts) -- show diagnostics for cursor
